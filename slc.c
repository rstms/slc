...
#define SERVICE_NAME  _T("screenlogger")
#define SERVICE_CHILD "C:\\Program Files (x86)\\Reliance Systems\\screenlogger\\screenlogger.exe"
...
VOID WINAPI ServiceMain(DWORD argc, LPTSTR *argv) {
    ...
    RunChildExecutable(_T(SERVICE_CHILD)); // Change path accordingly
